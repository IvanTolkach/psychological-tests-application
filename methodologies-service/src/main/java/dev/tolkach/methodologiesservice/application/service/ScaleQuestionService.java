...
public class ScaleQuestionService implements ScaleQuestionUseCase {
    ...
    public ScaleQuestionService(ScaleQuestionRepository scaleQuestionRepository, ScaleRepository scaleRepository, TestsPort testsPort) {
    ...
    public ScaleQuestion createScaleQuestion(ScaleQuestion scaleQuestion) {
        ...
        testsPort.validateQuestionExists(scaleQuestion.getQuestionId());
